...
import { ManageMenuContext } from "../context/managemenucontext";
import { AppMenuItemProps } from "@/types/types";

const ManageMenuitem = (props: AppMenuItemProps) => {
    const { activeMenu, setActiveMenu } = useContext(ManageMenuContext);
