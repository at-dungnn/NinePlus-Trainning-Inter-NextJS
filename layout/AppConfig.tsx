                ...
                <div className="grid">
                    ...
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                changeTheme("bootstrap4-light-purple", "light")
                            }
                        >
                            <img
                    ...
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                changeTheme("bootstrap4-dark-purple", "dark")
                            }
                        >
                            <img
                ...
                <div className="grid">
                    ...
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                changeTheme("md-light-deeppurple", "light")
                            }
                        >
                            <img
                    ...
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                changeTheme("md-dark-deeppurple", "dark")
                            }
                        >
                            <img
                ...
                <div className="grid">
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                changeTheme("mdc-light-indigo", "light")
                            }
                        >
                            <img
                                src="/layout/images/themes/md-light-indigo.svg"
                    ...
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                changeTheme("mdc-light-deeppurple", "light")
                            }
                        >
                            <img
                                src="/layout/images/themes/md-light-deeppurple.svg"
                    ...
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                changeTheme("mdc-dark-indigo", "dark")
                            }
                        >
                            <img
                                src="/layout/images/themes/md-dark-indigo.svg"
                    ...
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                changeTheme("mdc-dark-deeppurple", "dark")
                            }
                        >
                            <img
                                src="/layout/images/themes/md-dark-deeppurple.svg"
                ...
                <div className="grid">
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                changeTheme("tailwind-light", "light")
                            }
                        >
                            <img
                ...
                <div className="grid">
                    ...
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                changeTheme("lara-light-purple", "light")
                            }
                        >
                            <img
                    ...
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                changeTheme("lara-light-teal", "light")
                            }
                        >
                            <img
                    ...
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                changeTheme("lara-dark-purple", "dark")
                            }
                        >
                            <img
                    ...
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                changeTheme("lara-dark-teal", "dark")
                            }
                        >
                            <img
