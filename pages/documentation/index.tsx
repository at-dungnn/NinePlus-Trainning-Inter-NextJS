            ...
            <div className="grid">
                <div className="col-12">
                    <div className="card docs">
                        ...
                        <h5>Dependencies</h5>
                        <p>
                            Dependencies of Sakai are listed below and needs to
                            be defined at package.json.
                        </p>
...
`}</code>
                        ...
                        <h5>Structure</h5>
                        <p>
                            Sakai consist of a couple of folders where demos and
                            core layout have been separated.
                        </p>
...
export const LayoutProvider = (props) => {
    const [layoutConfig, setLayoutConfig] = useState({
        ...
        scale: 14                               //size of the body font size to scale the whole application
                        ...
                        <p>
                            Only the folders that are related to the layout
                            needs to move in to your project. We&apos;ve created
                            a short tutorial with details.
                        </p>
                        ...
                        <p>
                            ...
                            src/layout folder. Saving the changes will be
                            reflected instantly at your browser.
                        </p>
