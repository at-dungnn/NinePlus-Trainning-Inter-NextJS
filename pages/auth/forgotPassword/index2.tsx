...
const ForgotPassword: Page = () => {
    ...
    return (
        <div className={containerClassName}>
            <div
                className="flex align-items-center bg-cover bg-center justify-content-end min-h-screen min-w-screen overflow-hidden col-4 w-full h-full"
                style={{
                    backgroundImage: "url(/demo/images/access/BgLogin.png)",
                }}
            ></div>
            <div className=" col-8 flex flex-column align-items-end justify-content-center">
                <div
                    style={{
                        borderRadius: "56px",
                        padding: "0.3rem",
